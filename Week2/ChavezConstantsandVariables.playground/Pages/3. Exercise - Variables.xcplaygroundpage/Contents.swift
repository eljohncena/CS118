...
print("The code did compile because I saved the answer back into the variable. If it was a constant this would not have worked unless I used a new variable.")
