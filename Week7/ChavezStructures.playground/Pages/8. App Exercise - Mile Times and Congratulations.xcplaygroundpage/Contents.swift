...
var todaysRun = RunningWorkout(distance: 1600, time: 30, elevation: 100)
print(todaysRun)
print(todaysRun.averageMileTime)
...
struct Steps {
    var steps: Int {
        willSet{
            if newValue == goal {
                print("You met your goal for today!")
            }
        }
    }
    var goal: Int
...
var steps = Steps(steps: 900, goal: 10000)
steps.takeStep()
/*:
