 ...
 */
struct User {
    static var currentUser: User = User(userName: "johncena", email: "cantseeme@gmail.com", age: 45)
 ...
 */
let newUser = User(userName: "ForestGump", email: "BubbaGumpShrimpCo", age: 35)
