...
var favoriteBook = Book(title: "The girl with the dragon tatoo", author: "Stieg Larsson", pages: 544, price: 9.99)
print("My favorite book is \(favoriteBook.title), the author is \(favoriteBook.author). The book has \(favoriteBook.pages) pages and the price is $\(favoriteBook.price)")
/*:
...
var macbookPro = Laptop(yearPurchased: 2022)
...
var myHeight = Height(heightInCentimeters: 172)
