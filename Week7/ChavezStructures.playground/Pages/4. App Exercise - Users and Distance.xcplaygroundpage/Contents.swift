...
var John = User(name: "John", age: 26, height: 172, weight: 220, activityLevel: 7)

print("My name is \(John.name) and I'm \(John.age). I am \(John.height) cm tall and weigh \(John.weight). I workout several times a week and therefore I rate my activity level at a \(John.activityLevel)")
/*:
...
var kilometer = Distance(feet: 5000)
print(kilometer)
