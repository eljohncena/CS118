 ...
 */
var walking: [String] = ["Walk 5 miles today", "Walk up 10 flights of stairs"]
var running: [String] = ["Run 4 miles", "Do 5 100 meter sprints"]
...
if commited.isEmpty {
    print("You have not signed up for any challenges.")
}
else if commited.count == 1 {
    print("The challenge you have chosen is \(commited).")
}
else {
